...
const registerTemplate = (onSubmit, errMsg, errors, onReveal, revealPassword) => html`
...
<form @submit=${onSubmit}> 
    <div class="row space-top">
        <div class="col-md-4">
            ${errMsg ? html`<div class="form-group">${errMsg}</div>` : null}
            ...
            <div class="form-group">
                ...
                <label><input type="checkbox" @change=${onReveal}>See Password</label>
            </div>
            <div class="form-group">
